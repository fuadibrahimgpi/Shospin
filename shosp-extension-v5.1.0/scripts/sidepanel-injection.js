  ...
  if (temAudio) {
    ...
    if (tipo === 'conclusao') {
      ...
      combinedData.audio = {
        ...
        diagnostico: diagnosticoRetornoField.value || null,
        conduta: condutaRetornoField.value || null,
        tratamento: medicamentosPrescritosRetornoField.value || null
      };
    } else {
      combinedData.audio = {
        ...
        diagnostico: diagnosticoField.value || null,
        conduta: condutaField.value || null,
        tratamento: medicamentosPrescritosField.value || null
      };
    }
  }
